...
const BOTNAME = 'CYBER-MD|-WA-BOT™';
const FOOTERNAME = '> CYBER -  ＭＤ - Ｖ4';
global.owner = process.env.OWNER_NUMBER  || '923429837570' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=LU8hjKbB#6lW_IAiJOFKED_BptCCbzhleuGTI8Y2MehlKa5-VUrs' ,
...
FOOTER: process.env.FOOTER || '‌👨‍💻 CYBER -  ＭＤ - Ｖ5 👨‍💻',    
